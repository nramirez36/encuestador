            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        ...
                        encu.PatenteLetras = dr["PatenteLetras"].ToString();
                        encu.PatenteNumero = dr["PatenteNumero"].ToString();
                        encu.PatenteExtranjera = dr["PatenteExtranjera"].ToString();
